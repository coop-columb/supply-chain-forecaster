...
echo ""
echo "Note: For complete CI/CD integration with GitHub Actions, a cloud-based"
echo "      Kubernetes cluster is recommended, as GitHub Actions runners cannot"
echo "      directly access locally hosted clusters. See docs/deployment/kubernetes_setup.md"
echo "      for cloud-based options that enable real Kubernetes deployments with CI/CD."
echo ""
