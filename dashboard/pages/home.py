            ...
            dbc.Row(
                [
                    dbc.Col(
                        [
                            html.H1(
                                "Supply Chain Forecaster", className="text-center mb-4"
                            ),
                            html.P(
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    html.I(
                                        className="fas fa-database fa-3x text-primary text-center mt-4"
                                    ),
                                    dbc.CardBody(
                                        [
                                            html.H4(
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    html.I(
                                        className="fas fa-chart-line fa-3x text-success text-center mt-4"
                                    ),
                                    dbc.CardBody(
                                        [
                                            html.H4(
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    html.I(
                                        className="fas fa-exclamation-triangle fa-3x text-warning text-center mt-4"
                                    ),
                                    dbc.CardBody(
                                        [
                                            html.H4(
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    html.I(
                                        className="fas fa-cogs fa-3x text-info text-center mt-4"
                                    ),
                                    dbc.CardBody(
                                        [
                                            html.H4(
