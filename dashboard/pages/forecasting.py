    ...
    return html.Div([
        ...
        dbc.Tabs([
            dbc.Tab([
                dbc.Row([
                    dbc.Col([
                        create_upload_component("train-forecasting"),
                    ], width=12),
                ], className="mb-4"),
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            ...
                            dbc.CardBody([
                                html.Div(id="train-forecasting-model-selection"),
            ...
            dbc.Tab([
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            dbc.CardHeader(html.H5("Forecast Configuration")),
                            dbc.CardBody([
                                html.Div(id="forecast-model-selection"),
            ...
            ], label="Generate Forecast", tab_id="forecast-tab"),
            ...
            dbc.Tab([
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            dbc.CardHeader(html.H5("Cross-Validation Configuration")),
                            dbc.CardBody([
                                html.Div(id="cv-forecasting-model-selection"),
                                ...
                                dbc.Row([
                                    ...
                                    dbc.Col([
                                        html.Label("CV Strategy"),
                                        dcc.Dropdown(
                                            id="cv-forecasting-strategy",
                                            options=[
                                                {"label": "Expanding Window", "value": "expanding"},
            ...
            ], label="Cross-Validation", tab_id="cv-tab"),
        ], id="forecasting-tabs", active_tab="train-tab"),
    ])