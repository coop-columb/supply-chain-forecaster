        ...
        dbc.Tabs([
            dbc.Tab([
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            dbc.CardHeader(html.H5("Trained Models")),
                            dbc.CardBody([
                                dbc.Button(
                                    "Refresh Model List",
            ...
            ], label="Trained Models", tab_id="trained-tab"),
            
            dbc.Tab([
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            dbc.CardHeader(html.H5("Deployed Models")),
                            dbc.CardBody([
                                dbc.Button(
                                    "Refresh Model List",
                                ...
                                html.Div(id="deployed-models-list"),
                            ]),
                        ]),
                    ], width=12),
                ], className="mb-4"),
            ...
            ], label="Deployed Models", tab_id="deployed-tab"),
        ], id="model-management-tabs", active_tab="trained-tab"),
    ])
...
def create_model_details(model_info, is_deployed=False, id_prefix="model"):
    ...
    return dbc.Card([
        ...
        dbc.CardBody([
            ...
            ) if param_data else html.P("No parameters available."),
            ...
            ) if metrics_data else html.P("No metrics available."),
